...
<div x-data="combobox" class="flex w-full  flex-col gap-1">

    <div class="relative flex w-full" x-on:keydown="handleKeydownOnOptions($event)"
        x-on:keydown.esc.window="isOpen = false, openedWithKeyboard = false" x-init="setSelectedOption(options[222])">
        ...
        <input :id="$id('phoneNumber')" name="{{ $name }}" type="tel"

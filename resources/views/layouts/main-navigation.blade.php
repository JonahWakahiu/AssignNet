<nav class="bg-tia-50 border-b border-slate-200">
    <div class="flex items-center h-20 container mx-auto">
        ...
        <div class="flex gap-3 items-center">
            <svg version="1.1" class="size-14 fill-tia-700 stroke-2" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="flex gap-4 ms-auto text-slate-900">
            ...
            <a href="" @class(['font-semibold hover:text-tia-500'])>Why Us</a>
            <a href="" @class(['font-semibold hover:text-tia-500'])>Services</a>

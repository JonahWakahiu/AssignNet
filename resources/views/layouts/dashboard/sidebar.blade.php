<aside class="flex-shrink-0 w-64 bg-white border-r border-slate-300 transition-all duration-300" x-cloak
    :class="{ '-ml-64': !sidebarOpen }">
    <div class="flex gap-1.5 items-center justify-center mt-4">
        <svg version="1.1" class="size-10 fill-tia-500 stroke-2" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
        ...
        <h5 class="font-extrabold text-slate-700">AssignNet</h5>
    </div>

    <div class="border-b border-slate-300 my-2"></div>

    <div class="px-5 mt-7">
        <p class="text-slate-700">Main</p>

        <ul class="mt-2 space-y-0.5">
            <li><a href="{{ route('dashboard') }}" @class([
                'px-3 block w-full  py-2 hover:text-tia-500 rounded-md inline-flex items-center',
                'text-tia-500 hover:text-tia-600' => request()->routeIs('dashboard'),
            ])>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        class="bi bi-columns-gap inline size-4 me-2" viewBox="0 0 16 16">
                        <path
